...
{#if isOpen}
	...
	>
		...
		<!-- Modal Panel -->
		<div
			class="relative w-full max-w-lg transform overflow-hidden rounded-xl border border-slate-200 bg-white p-6 text-left shadow-2xl transition-all dark:border-white/10 dark:bg-gradient-to-b dark:from-slate-800/50 dark:to-slate-900 sm:my-8"
		>
			...
			<div class="mt-6 flex justify-end gap-3">
				...
				<button
					type="button"
					class="inline-flex justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed disabled:opacity-50"
