...
<div class="flex min-h-[80vh] flex-col items-center justify-center">
	<div class="w-full max-w-md space-y-8 rounded-2xl bg-white/90 p-8 shadow-xl backdrop-blur-sm ring-1 ring-slate-900/10 dark:bg-slate-900/50 dark:ring-white/10">
		<div class="text-center">
			...
			<h2 class="mt-6 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">{isSignUp ? 'Create Account' : 'Welcome Back'}</h2>
			<p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{isSignUp ? 'Sign up to start your journey' : 'Sign in to track your prayer journey'}</p>
		</div>
		...
		<div class="mt-8 space-y-6">
            <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input
                                ...
                                required
                                bind:value={name}
                                class="block w-full rounded-md border-0 bg-slate-100 py-3 px-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-900/10 dark:bg-white/5 dark:text-white dark:ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                ...
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-600 dark:text-gray-300">Email address</label>
                    <div class="mt-1">
                        <input
                            id="email"
                            name="email"
            ...
            <div class="relative">
                ...
                <div class="relative flex justify-center">
                    <span class="bg-slate-900 px-2 text-sm text-gray-500 dark:text-gray-400">Or continue with</span>
                </div>
            </div>

			<button
				onclick={handleGoogleLogin}
				class="group relative flex w-full justify-center rounded-lg bg-white px-4 py-3 text-sm font-semibold text-gray-900 transition-all hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-white dark:focus:ring-offset-slate-900"
			>
            ...
            <div class="text-center mt-6">
                <button
                    ...
                    class="px-4 py-3 text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors rounded-md"
                >
